...
Use VDFUnit.pkg
Use cVDFUnitResultList.pkg
Use cVDFUnitResultXml.pkg
...
Object oResultXml is a cVDFUnitResultXml
...
Object VDFUnitTestRunner_vw is a View
    ...
    Object oOutputBox is a cVDFUnitResultList
        Set Size to 110 400
...
Procedure Execute
    Send Execute to oTestFixtureRunner (oOutputBox(VDFUnitTestRunner_vw(Self)))
    Send OutputResults to oTestFixtureRunner (oOutputBox(VDFUnitTestRunner_vw(Self)))
